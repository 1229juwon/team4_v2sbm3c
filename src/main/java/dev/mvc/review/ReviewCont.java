...
//    request.setAttribute("fcateVO", fcateVO);
    ...
    // 쇼핑몰의 상품 정보 등록
    mav.setViewName("/review/create"); // /webapp/WEB-INF/views/contents/create_product.jsp
...
//    
//    // 로그인 Cookie + 쇼핑카트
        mav.setViewName("/review/list_by_cateno_search_paging");  // /contents/list_by_cateno_search_paging.jsp ★ 
  ...
  public ModelAndView delete(int reviewno) {
    ...
    if (cnt > 0) { // 정상 삭제
      ...
      mav.setViewName("/review/msg"); // /webapp/WEB-INF/views/fcate/msg.jsp      
    }
