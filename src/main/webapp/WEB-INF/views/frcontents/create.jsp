...
<DIV class='content_body'>
  ...
  <FORM name='frm' method='POST' action='./create.do' enctype="multipart/form-data">
    ...
    <div>
       <label>가게 이름</label>
       <input type='text' name='fr_name' value='이름' required="required" 
                 autofocus="autofocus" class="form-control" style='width: 100%;'>
    </div>
    <div>
       <label> 맛집 설명</label>
       <textarea name='fr_content' required="required" class="form-control" rows="12" style='width: 100%;'>가을 단풍보며 멍때리기</textarea>
    </div>
    <div>
       <label>맛집 주소</label>
